...
* [samples and leaked source etc](https://vxug.fakedoma.in/samples.html)
...
* [Perform External Black-box Penetration Testing in Organization with “ZERO” Information](https://gbhackers.com/external-black-box-penetration-testing/)
* Masking Malicious Memory Artifacts
    - [Part I: Phantom](https://www.forrest-orr.net/post/malicious-memory-artifacts-part-i-dll-hollowing)
    - [Part II: Insights](https://www.forrest-orr.net/post/masking-malicious-memory-artifacts-part-ii-insights-from-moneta)
* [hacking blogs](https://hakin9.org/blog-2/)
* [Light Blue Touchpaper](https://www.lightbluetouchpaper.org/) - Security Research, Computer Laboratory, University of Cambridge

*GitHub*
* [ReddyyZ/GhostShell](https://github.com/ReddyyZ/GhostShell) - Malware indetectable, with AV bypass techniques, anti-disassembly, etc.
...
* [shellphish/how2heap](https://github.com/shellphish/how2heap) - various heap exploitation techniques

*anti-virus*
* [GitHub topics on anti-virus](https://github.com/topics/antivirus)
    - [zelon88 / HR-AV](https://github.com/zelon88/HR-AV)
    - [Windows Inspector driver](https://github.com/repnz/windows-inspector)
